...
{
    public class Down_bankdfModel : PageModel
    {
        ...
        public ActionResult OnPostDownloadFile(string? v301x913, string? c036x9210)
        {
            try
            {
                ...
                if (HttpContext.Session.GetString(SessionFile) != null)
                {
                    ...
                    {
                        if (HttpContext.Session.GetString(Down_bankdfModel.SessionCount) != null)
                        {
                            t_ = Convert.ToInt32(HttpContext.Session.GetString(Down_bankdfModel.SessionCount));
                        }
                        ...
                        else
                        {
                            ...
                            Response.Redirect("/Imagedata/Down_bankdf?dolrchd=1");
                    ...
                    else
                    {
                        ...
                        HttpContext.Session.SetString(Down_bankdfModel.SessionCount, "0");
                    }
                }
                else
                {
                ...
                if (repsave != null)
                {
                    ...
                    if (chkr == 1)
                    {
                        Response.Redirect("/Imagedata/Down_bankdf");
                    }
                }
                ...
                using (var client = new HttpClient())
                {
                    ...
                    string ct = HttpContext.Session.GetString(Down_bankdfModel.SessionCount);
