...
{
    public class IntercitySubbookModel : PageModel
    {
        ...
        public void OnGet()
        {
            try
            {
                ...
                apiURL = MyConfig.GetValue<string>("AppSettings:ibcs.api") + "IntercitySubbook/";
        ...
        public ActionResult OnPostDownloadFile(string? v301x913, string? c036x9210)
        {
            try
            {
                ...
                if (HttpContext.Session.GetString(SessionFile) != null)
                {
                    ...
                    {
                        if (HttpContext.Session.GetString(IntercitySubbookModel.SessionCount) != null)
                        {
                            t_ = Convert.ToInt32(HttpContext.Session.GetString(IntercitySubbookModel.SessionCount));
                        }
                    ...
                    else
                    {
                        ...
                        HttpContext.Session.SetString(IntercitySubbookModel.SessionCount, "0");
                    }
                }
                else
                {
                ...
                if (repsave != null)
                {
                    ...
                    if (chkr == 1)
                    {
                        Response.Redirect("/Reports/IntercitySubbook");
                    }
                }
                ...
                using (var client = new HttpClient())
                {
                    ...
                    string ct = HttpContext.Session.GetString(IntercitySubbookModel.SessionCount);
        ...
        public JsonResult OnPostGetFiles([FromBody] Params_Rep2 PR)
        {
            try
            {
                ...
                {
                    client.BaseAddress = new Uri(apiURL);
                    BkIntercityReportRequest req = new BkIntercityReportRequest()
                    {
                    ...
                    var responseTask = client.PostAsJsonAsync<BkIntercityReportRequest>("getIntercityBkReport", req);
                    responseTask.Wait();
