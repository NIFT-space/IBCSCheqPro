...
{
    public class BkNETSModel : PageModel
    {
        ...
        public class BKReturn
        {
            ...
            public string sel_ddl_data { get; set; }
        }
        ...
        public void OnGet()
        {
            ...
            apiURL = MyConfig.GetValue<string>("AppSettings:ibcs.api") + "BkNETS/";
        ...
        public ActionResult OnPostDownloadFile(string? v301x913, string? c036x9210)
        {
            ...
            if (HttpContext.Session.GetString(SessionFile) != null)
            {
                ...
                {
                    if (HttpContext.Session.GetString(BkNETSModel.SessionCount) != null)
                    {
                        t_ = Convert.ToInt32(HttpContext.Session.GetString(BkNETSModel.SessionCount));
                    }
                ...
                else
                {
                    ...
                    HttpContext.Session.SetString(BkNETSModel.SessionCount, "0");
                }
            }
            else
            {
            ...
            if (repsave != null)
            {
                ...
                if (chkr == 1)
                {
                    Response.Redirect("/Reports/BkNETS");
                }
            }
            ...
            using (var client = new HttpClient())
            {
                ...
                string ct = HttpContext.Session.GetString(BkNETSModel.SessionCount);
