...
{
    public class IntercityBranchTSModel : PageModel
    {
        ...
        public void OnGet()
        {
            try
            {
                ...
                apiURL = MyConfig.GetValue<string>("AppSettings:ibcs.api") + "IntercityBranchTS/";
        ...
        public ActionResult OnPostDownloadFile(string? v301x913, string? c036x9210)
        {
            try
            {
                ...
                if (HttpContext.Session.GetString(SessionFile) != null)
                {
                    ...
                    {
                        if (HttpContext.Session.GetString(IntercityBranchTSModel.SessionCount) != null)
                        {
                            t_ = Convert.ToInt32(HttpContext.Session.GetString(IntercityBranchTSModel.SessionCount));
                        }
                    ...
                    else
                    {
                        ...
                        HttpContext.Session.SetString(IntercityBranchTSModel.SessionCount, "0");
                    }
                }
                else
                {
                ...
                if (repsave != null)
                {
                    ...
                    if (chkr == 1)
                    {
                        Response.Redirect("/Reports/IntercityBranchTS");
                    }
                }
                ...
                using (var client = new HttpClient())
                {
                    ...
                    string ct = HttpContext.Session.GetString(IntercityBranchTSModel.SessionCount);
        ...
        public JsonResult OnPostGetFiles([FromBody] Params_Rep2 PR)
        {
            try
            {
                ...
                {
                    client.BaseAddress = new Uri(apiURL);
                    IntercityBrReportRequest req = new IntercityBrReportRequest
                    {
                        ...
                        RepName = "brts%",
                        BDelivered = Convert.ToInt32(PR.DDL_BankType)
                    };

                    var responseTask = client.PostAsJsonAsync<IntercityBrReportRequest>("getIntercityBrReport", req);
                    responseTask.Wait();
