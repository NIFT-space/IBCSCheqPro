...
{
    public class SubbookModel : PageModel
    {
        public const string SessionCount = "_count";
        public const string SessionFile = "_file";
        public static string apiURL = "", comm_apiURL = "", downurl="";
        ...
        public void OnGet()
        {
            try
            {
                ...
                apiURL = MyConfig.GetValue<string>("AppSettings:ibcs.api") + "Subbook/";
                comm_apiURL = MyConfig.GetValue<string>("AppSettings:ibcs.api") + "BkTrSc/";
				downurl = MyConfig.GetValue<string>("AppSettings:ibcs.api") + "BkHelp/";
        ...
        public ActionResult OnPostDownloadFile(string? v301x913, string? c036x9210)
        {
            try
            {
                ...
                if (HttpContext.Session.GetString(SessionFile) != null)
                {
                    ...
                    {
                        if (HttpContext.Session.GetString(SubbookModel.SessionCount) != null)
                        {
                            t_ = Convert.ToInt32(HttpContext.Session.GetString(SubbookModel.SessionCount));
                        }
                    ...
                    else
                    {
                        ...
                        HttpContext.Session.SetString(SubbookModel.SessionCount, "0");
                    }
                }
                else
                {
                ...
                if (repsave != null)
                {
                    ...
                    if (chkr == 1)
                    {
                        Response.Redirect("/Reports/Subbook");
                    }
                }
                ...
                using (var client = new HttpClient())
                {
                    ...
                    string ct = HttpContext.Session.GetString(SubbookModel.SessionCount);
